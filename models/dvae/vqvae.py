...
class Decoder(nn.Module):
    def __init__(
            self, in_channel, out_channel, channel, n_res_block, n_res_channel, stride, conv_module,
...
class VQVAE(nn.Module):
    def __init__(
        ...
        self.dec_t = Decoder(
            codebook_dim, codebook_dim, channel, n_res_block, n_res_channel, stride=2, conv_module=conv_module,
